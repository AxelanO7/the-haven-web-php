...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-haven"><i class="fas fa-fw fa-plus"></i> Tambah Data Karyawan</h6>
    </div>
	
	<?php echo form_open('Karyawan/store'); ?>
		<div class="card-body">
			<div class="row">
				<?php
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<input autocomplete="off" type="text" name="kode_karyawan" required class="form-control"/>
				</div>
				<div class="form-group col-md-12">
					<label class="font-weight-bold">Nama Karyawan</label>
					<input autocomplete="off" type="text" name="nama_karyawan" required class="form-control"/>
				</div>
				<div class="form-group col-md-12">
					<label class="font-weight-bold">Posisi Karyawan</label>
					<input autocomplete="off" type="text" name="posisi" required class="form-control"/>
				</div>
				<div class="form-group col-md-12">
