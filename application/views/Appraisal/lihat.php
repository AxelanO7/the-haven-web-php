	...
	<div class="card shadow mb-4">
		...
		<div class="card-footer text-right">
			<div class="" role="group">
				<a data-toggle="tooltip" data-placement="bottom" title="Edit Data" href="<?= base_url('Appraisal/edit/' . $Appraisal->id_appraisal) ?>" class="btn btn-haven btn-sm"><i class="fa fa-edit"> Edit Data</i></a>
				<a data-toggle="tooltip" data-placement="bottom" title="Hapus Data" href="<?= base_url('Appraisal/destroy/' . $Appraisal->id_appraisal) ?>" onclick="return confirm ('Apakah anda yakin untuk meghapus data ini')" class="btn btn-danger btn-sm"><i class="fa fa-trash"> Hapus Data</i></a>
			</div>
		</div>
		<?php echo form_close() ?>
	</div>
