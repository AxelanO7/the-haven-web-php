...
<div class="card shadow mb-4">
	...
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-haven"><i class="fa fa-table"></i> Hitung Berdasarkan Query</h6>
	</div>
			...
			<div class="row d-flex justify-content-center">
				...
				<div class="form-group col-xl-4">
					...
					<select name="id_subkriteria_fuzzy_<?=$variabel->id_kriteria ?>" class="form-control" required>
						...
						?>
						<option value="<?=$himpunan->id_subkriteria_fuzzy?>" <?php if (isset($_POST['hitung'])) {if($_POST['id_subkriteria_fuzzy'.$variabel->id_kriteria] == $himpunan->id_subkriteria_fuzzy) {echo "selected";}}?>><?=$himpunan->nama_subkriteria?></option>
						<?php } ?>
					</select>
				</div>
				<?php
