...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-haven"><i class="fas fa-fw fa-plus"></i> Tambah Data Departemen</h6>
    </div>
	
	<?php echo form_open('Departemen/store'); ?>
		<div class="card-body">
			<div class="row">
				<div class="form-group col-md-12">
					<label class="font-weight-bold">Nama Departemen</label>
					<input autocomplete="off" type="text" name="nama_departemen" required class="form-control"/>
				</div>
			</div>
		</div>
